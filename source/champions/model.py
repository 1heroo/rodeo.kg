...
#
#     first_champ = relationship('Champion', back_populates='first_place')
#     second_champ = relationship('Champion', back_populates='second_place')
#     third_champ = relationship('Champion', back_populates='third_place')
#
#     def __str__(self):
